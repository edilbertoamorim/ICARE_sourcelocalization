...
leadfdc.label(1:length(leadfdc.label))= strcat('E',  leadfdc.label(1:length(leadfdc.label)));
elec.label = leadfdc.label(1:length(leadfdc.label));
...
dir_path= 'C:\Users\gvelasquez\Documents\Source_localization_Fei\';

mat_edf_path = 'preprocessed_28_68f2c833dbd35ffb062b43aa9a9b350c0a349631ae0f4be88547c87c60a63b1c_20131016_071324.edf.mat';
