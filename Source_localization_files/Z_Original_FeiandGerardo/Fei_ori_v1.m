...
%% Add paths
addpath C:\Users\PKandhare\Documents\MATLAB\fieldtrip-20211102\external\eeglab
addpath  C:\Users\PKandhare\Documents\MATLAB\fieldtrip-20211102
ft_defaults

%% Input and output folder
PID = 'C:\Users\PKandhare\Desktop\Amoriom_LAB\Projects\Source_localization_Fei\dataset\YNH30';
Folder2Save = 'C:\Users\PKandhare\Desktop\Amoriom_LAB\Projects\Source_localization_Fei\document';
...
% Segment the brain, skull and scalp
cfg                = [];
...
dir_path= 'C:\Users\PKandhare\Desktop\Amoriom_LAB\Projects\Source_localization_Fei\dataset\';
mat_edf_path = 'preprocessed_30_108b0b60868b449ef6d3d64e45db3b67f8b30d495d7ef0e3a18d100967871af9_20130119_090307.edf.mat';
...
peak_time = [20 21;21.50 22.50;24 25.80;26.40 27;28.70 29.70];
...
atlas = ft_read_atlas('C:\Users\PKandhare\Documents\MATLAB\fieldtrip-20211102/template/atlas/aal/ROI_MNI_V4.nii');
cfg = [];
...
indx = find(sourcemodel2.tissue==3); % where x is the number of your choice
indx=intersect(indx,insideix);
no_of_sources=100;
figure; hold on;
ft_plot_mesh(vol.bnd(1), 'edgecolor', 'none','vertexsize',2); %brain
ft_plot_mesh(vol.bnd(3),'edgecolor', 'none', 'facecolor',[0.5 0.5 0.5],'face alpha',0.1); %scalp
alpha 0.1; camlight;
ft_plot_mesh(leadfdc.pos(leadfdc.inside,:),'vertexsize',2);
loca=leadfdc.pos((indx(1:no_of_sources)), :);
plotColors = hsv(no_of_sources);
for i=1:1:no_of_sources
    x=loca(i,1);
    y=loca(i,2);
    z=loca(i,3);
    p=plot3(x,y,z,'o','Color',[plotColors(1,1),plotColors(1,2),plotColors(1,3)]);
    p.LineWidth = 1;
    str = string(num2str(i));
%     textscatter3(x,y+2,z,str,'FontWeight','bold');
...
indx = find(sourcemodel2.tissue==4); % where x is the number of your choice
indx=intersect(indx,insideix);
no_of_sources=100;
% figure; hold on;
% ft_plot_mesh(vol.bnd(1), 'edgecolor', 'none','vertexsize',2); %brain
...
for i=1:1:no_of_sources
    ...
    y=loca(i,2);
    z=loca(i,3);
    p=plot3(x,y,z,'o','Color',[plotColors(10,1),plotColors(10,2),plotColors(10,3)]);
    p.LineWidth = 1;
    str = string(num2str(i));
%     textscatter3(x,y+2,z,str,'FontWeight','bold');
