function [EEG, computationTimes] = no_catch_prepPipeline(EEG, params)
%  IMPORTANT: modification of the prepPipeline with no exceptions caught.
% This is necessary in order to apply it to 5min segments of patients.
%
