function [S] = get_similarities_for_all_bursts_patient(similarity_fn, patient_burst_data_obj, data)
...
%         S(i,j) = similarity(burst_i, burst_j) when i~=j, and S(i,i) = 1
    ...
    if nargin < 3
        ...
        burst_data_cell = patient_burst_data_obj;
    elseif nargin == 3
        bursts_extracted = false;
        burst_ranges = patient_burst_data_obj;
    end
    ...
    burst_splice_n_samples = burst_splice_time * PrepArtifactParams.get_params('target_frequency')-1;
